...
var WebGLGraphicsDevice = (function () {
    ...
    WebGLGraphicsDevice.prototype.drawArrayVAO = function (drawParametersArray, globalTechniqueParametersArray, sortMode) {
        ...
        for (var n = 0; n < numDrawParameters; n += 1) {
            ...
            vaoMatch = (lastEndStreams === endStreams && lastDrawParameters._indexBuffer === indexBuffer);
            for (v = 0; vaoMatch && v < endStreams; v += 3) {
                vaoMatch = (lastDrawParameters[v] === drawParameters[v] && lastDrawParameters[v + 1] === drawParameters[v + 1] && lastDrawParameters[v + 2] === drawParameters[v + 2]);
            }
            ...
            if (!vaoMatch) {
                ...
                if (indexBuffer && (!lastDrawParameters || lastDrawParameters._indexBuffer !== indexBuffer)) {
                    indexFormat = indexBuffer.format;
                    indexStride = indexBuffer.stride;
                }
